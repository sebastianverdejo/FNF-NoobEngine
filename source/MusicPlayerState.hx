...
class MusicPlayerState extends MusicBeatState
{
    ...
    override function create()
    {
		...
		var somethin:FlxText = new FlxText(12, FlxG.height - 24, 0, "This OST is being worked on, so expect bugs.", 12);
		somethin.scrollFactor.set();
		somethin.setFormat("VCR OSD Mono", 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		add(somethin);
